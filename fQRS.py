...
def get_peaks(lead_segment: [float]):
    ...
    qrs_search_segment = np.reshape(qrs_search_segment,
                                         (qrs_search_segment.shape[0], qrs_search_segment.shape[1]))
    qrs_search_segment = qrs_search_segment.ravel()
    qrs_base_amp = statistics.mean([qrs_search_segment[0], qrs_search_segment[-1]])

    gmax = get_global_peak(qrs_search_segment, qrs_base_amp)
